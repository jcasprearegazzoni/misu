-- Corrige reservas y slots para soportar cruces de medianoche sin perder turnos.

-- 1) Ajustar constraint de anti-solapamiento para reservas que terminan al dia siguiente.
...
-- 2) Reemplazar RPC publica de slots disponibles con soporte midnight-safe.
