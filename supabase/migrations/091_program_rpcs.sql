-- RPC para generar todos los bookings de un programa estructurado al inscribir a un alumno.
-- Itera día por día entre fecha_inicio y fecha_fin del programa,
-- crea un booking confirmado por cada día que coincida con dias_semana,
-- y actualiza classes_remaining en student_programs con la cantidad generada.
